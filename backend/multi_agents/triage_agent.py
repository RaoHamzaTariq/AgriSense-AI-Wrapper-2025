...
from .crop_agent import crop_analysis_agent
from .weather_agent import weather_analyzer_agent
...
triage_agent = Agent(
    ...
    4. Combine the agent response into a short, formal reply.
...
# Example:
# - Speak in a Formal, simple Urdu-English tone.
    ...
    # Please be formal and use mix of english or urdu.
    # 